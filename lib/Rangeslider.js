  ...
  function Slider(props, context) {
    ...
    _this.handleUpdate = function () {
      ...
      var _this$props = _this.props,
          ...
          extendedMax = _this$props.extendedMax,
          max = _this$props.max;
    ...
    _this.handleKeyDown = function (e) {
      ...
      var _this$props2 = _this.props,
          ...
          extendedMax = _this$props2.extendedMax,
    ...
    _this.getValueFromPosition = function (pos) {
      ...
      var _this$props4 = _this.props,
          ...
          extendedMax = _this$props4.extendedMax,
          step = _this$props4.step;

      var percentage = (0, _utils.clamp)(pos, 0, extendedMax) / (limit || 1);
      var baseVal = step * Math.round(percentage * (max - min) / step);
      var value = orientation === "horizontal" ? baseVal + min : max - baseVal;

      return (0, _utils.clamp)(value, min, extendedMax);
    };
...
Slider.propTypes = {
  ...
  extendedMax: _propTypes2.default.number,
